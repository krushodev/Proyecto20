  ...
  <div class="terminos-page">
      ...
      <div>
        ...
        <article class="terminos-article">
          <section id="intro" class="terminos-section">
            <div><span>01</span><h2>Uso de la Plataforma</h2></div>
            <div>
          ...
          <section id="privacy" class="terminos-section">
            <div><span>02</span><h2>Política de Privacidad</h2></div>
            <div>
              ...
              <ul>
                <li><span data-icon="check">✓</span><span>Solo solicitamos información personal cuando la necesitamos realmente para brindarle un servicio de alta precisión.</span></li>
                <li><span data-icon="check">✓</span><span>La recopilamos por medios justos y legales, con su conocimiento y consentimiento.</span></li>
                <li><span data-icon="check">✓</span><span>No compartimos ninguna información de identificación personal públicamente o con terceros, excepto cuando lo exija la ley.</span></li>
              </ul>
            </div>
          </section>

          <section id="warranty" class="terminos-section">
            <div><span>03</span><h2>Garantía de Ingeniería</h2></div>
            <div class="section-grid">
              <div>
                <h3>Cobertura Estándar</h3>
                <p>Todas las piezas Vittorio cuentan con una garantía limitada de 5 años contra defectos de fabricación en el movimiento y la estructura de la caja.</p>
              </div>
              <div>
                <h3>Servicio Técnico</h3>
                <p>Para mantener la integridad de la pieza, cualquier intervención técnica debe ser realizada exclusivamente por centros autorizados Vittorio.</p>
              </div>
            </div>
          </section>

          <section id="shipping" class="terminos-section">
            <div><span>04</span><h2>Logística de Entrega</h2></div>
            <div>
              <p>Debido a la naturaleza exclusiva de nuestras piezas, cada envío se realiza bajo estrictos protocolos de seguridad y seguro de valor total.</p>
            </div>
            <div class="section-grid">
              <div><h3>Certificación de Envío</h3><p>Transporte blindado y seguimiento satelital 24/7 para envíos internacionales con cobertura total.</p></div>
              <div><h3>Política de Devoluciones</h3><p>Aceptamos devoluciones dentro de los primeros 30 días si la pieza no cumple con sus expectativas de ingeniería.</p></div>
            </div>
          </section>
        </article>
      </div>
    ...
    <section class="terminos-footer">
      <div>
        ...
        <form><input placeholder="CORREO ELECTRÓNICO" type="email" /><button>Unirse</button></form>
      </div>
    </section>
  </div>
@endsection
